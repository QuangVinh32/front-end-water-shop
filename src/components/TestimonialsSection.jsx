    ...
    >
      ...
      <div>
        ...
        <div className="flex justify-center gap-4 sm:mt-0 mt-2">
          ...
          <button
            className="swiper-button-next-custom bg-amber-300 w-12 h-12 rounded-full border border-gray-200 flex items-center justify-center hover:bg-blue-500 hover:text-white cursor-pointer transition-colors"
          >
