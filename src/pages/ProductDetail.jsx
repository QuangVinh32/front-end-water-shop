...
const ProductDetail = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-10">
      <Link to="/product" className="text-green-600 text-sm hover:underline mb-4 inline-block">← Quay lại</Link>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 bg-white shadow-md rounded-xl p-6">
        ...
        <div className="flex flex-col justify-center">
          ...
          <p className="text-gray-600 mb-4">{product.description || 'Thức uống thơm ngon, giải khát tuyệt vời.'}</p>
          <p className="text-xl font-semibold text-orange-600 mb-6">{product.price}₫</p>
